/**
 * Product Interface
 * Conforming to the schema defined in PROJECT.md
 */
 ...
 * --------------------------------------------------------------------------
 * Currently, all product data is stored in this static mock array.
 * To integrate Sanity.io in the future:
 * 
 * 1. Install dependencies:
 *    npm install @sanity/client next-sanity @sanity/image-url
 * 
 * 2. Setup Sanity Credentials in environment variables:
 *    NEXT_PUBLIC_SANITY_PROJECT_ID="your_project_id"
 *    NEXT_PUBLIC_SANITY_DATASET="production"
 *    SANITY_API_READ_TOKEN="your_read_token"
 * 
 * 3. Create a Sanity client setup (e.g., `src/lib/sanity.ts`):
 ...
 *    });
 * 
 * 4. Replace the static `products` array below with a dynamic GROQ query:
 ...
 *    }
 * 
 * 5. Update categories and collection fetching accordingly.
 * ==========================================================================
 */

export const products: Product[] = [
  // ─── BRIDAL PRODUCTS (12 Items) ───
  {
    id: 1,
