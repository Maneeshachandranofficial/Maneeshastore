                ...
                <div className="flex flex-wrap gap-4">
                  {['S', 'M', 'L', 'XL'].map(size => (
                    <button 
                      ...
                      className={cn(
                        "w-14 h-14 border flex items-center justify-center font-sans text-sm transition-colors",
                        selectedSize === size 
            ...
            <div className="flex flex-col gap-4 mb-16">
              {isCustomiseOnly ? (
                <button 
                  ...
                  className="w-full bg-charcoal text-cream py-5 text-center font-sans tracking-widest uppercase text-sm hover:bg-charcoal-light transition-colors"
                >
                  Customise Order
                </button>
              ) : (
              ...
              <div className="flex gap-4">
                <button 
                  ...
                  className="flex-1 bg-transparent border border-charcoal/20 py-4 flex items-center justify-center gap-2 font-sans tracking-widest uppercase text-xs text-charcoal hover:border-charcoal transition-colors"
                >
                  <Heart className={cn("w-3 h-3 transition-colors", saved ? "text-maroon fill-maroon" : "")} /> 
                  {saved ? 'Saved' : 'Save'}
                </button>
                <button className="flex-1 bg-transparent border border-charcoal/20 py-4 flex items-center justify-center gap-2 font-sans tracking-widest uppercase text-xs text-charcoal hover:border-charcoal transition-colors">
