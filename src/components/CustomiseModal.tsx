            ...
            <div className="p-8">
              ...
              <div className="flex flex-col gap-4">
                <a 
                  ...
                  className="w-full bg-maroon text-cream py-4 rounded-full flex items-center justify-center gap-3 font-sans tracking-[0.2em] uppercase text-xs hover:bg-maroon-dark transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-[#25D366] text-white py-4 rounded-full flex items-center justify-center gap-3 font-sans tracking-[0.2em] uppercase text-xs hover:bg-[#20bd5a] transition-colors"
                >
                ...
                <div className="grid grid-cols-3 gap-4 mt-2">
                  <a href="tel:+919526266369" className="flex flex-col items-center justify-center py-4 rounded-xl border border-charcoal/10 hover:border-maroon/40 transition-colors group">
                  ...
                  <a href="mailto:maneeshachandranofficial@gmail.com" className="flex flex-col items-center justify-center py-4 rounded-xl border border-charcoal/10 hover:border-maroon/40 transition-colors group">
                  ...
                  <a href="https://instagram.com/maneesha_chandran_official" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center py-4 rounded-xl border border-charcoal/10 hover:border-maroon/40 transition-colors group">
