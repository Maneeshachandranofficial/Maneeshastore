    ...
    <section className="px-4 py-10 md:px-8">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-maroon px-6 py-20 text-center md:py-28">
        ...
        <div className="pointer-events-none absolute inset-0 opacity-[0.08]">
          <div className="absolute -left-16 -top-16 h-72 w-72 rounded-full border border-white" />
          <div className="absolute -bottom-24 -right-10 h-96 w-96 rounded-full border border-white" />
        </div>
        ...
        >
          <span className="eyebrow mb-6 text-white/70">By Appointment</span>
          <h2 className="display-md text-white">
            Begin your <span className="text-white">bespoke journey</span>
          </h2>
          ...
          <a
            ...
            className="group mt-10 inline-flex items-center gap-3 rounded-full bg-white px-9 py-4 font-sans text-[12px] uppercase tracking-[0.2em] text-black transition-all duration-300 hover:bg-white/85"
          >
